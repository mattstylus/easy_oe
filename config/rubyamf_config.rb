...
module RubyAMF
  module Configuration
    ...
    ClassMappings.register(
      ...
      :ruby          => 'Category',
      :type          => 'active_record',
      :associations  => ["categories", "types"],
      :attributes    => ["id", "parent_id", "description", "created_at", "updated_at", "url", "order", "title"])

    ClassMappings.register(
      :actionscript  => 'CustomPage',
      :ruby          => 'CustomPage',
      :type          => 'active_record',
      :attributes    => ["id", "category_id", "title", "sub_title", "created_at", "updated_at"])

    ClassMappings.register(
      :actionscript  => 'Image',
      :ruby          => 'Image',
      :type          => 'active_record',
      :associations  => ["thumbnails", "parent"],
      :attributes    => ["id", "category_id", "description", "link_type_id", "link", "caption", "parent_id", "size", "width", "height", "content_type", "filename", "thumbnail", "created_at", "updated_at"])

    ClassMappings.register(
      :actionscript  => 'LinkType',
      :ruby          => 'LinkType',
      :type          => 'active_record',
      :attributes    => ["id", "description", "created_at", "updated_at"])

    ClassMappings.register(
      :actionscript  => 'Listing',
      :ruby          => 'Listing',
      :type          => 'active_record',
      :associations  => ["listing_images"],
      :attributes    => ["id", "category_id", "title", "sub_title", "location_city", "location_area", "location_postcode", "event_date", "type_id", "contact_email_address", "contact_name", "user_id", "content", "reference", "contact_number", "created_at", "updated_at"])

    ClassMappings.register(
      :actionscript  => 'Page',
      :ruby          => 'Page',
      :type          => 'active_record',
      :attributes    => ["id", "custom_page_id", "title", "content", "order", "created_at", "updated_at"])

    ClassMappings.register(
      :actionscript  => 'SubPage',
      :ruby          => 'SubPage',
      :type          => 'active_record',
      :attributes    => ["id", "page_id", "title", "content", "order", "location_title", "location_city", "location_area", "location_postcode", "created_at", "updated_at"])
    ...
    ClassMappings.register(
      ...
      :attributes    => ["id", "category_id", "description", "created_at", "updated_at", "title", "url", "order"])
  end
end